...
blocks for the BST, AVLTree, and Heap data structures.
...
class Node():
    ...
    Given a node t, you can
    visualize the node by running str(t) in the python interpreter.
...
class BinaryTree():
    ...
    def print_tree(self, traversal_type):
        ...
        types of tree traversals: preorder, inorder, and postorder.
        All three of these traversals are implemented for you
        as a reference on how to
    ...
    def __len__helper(node):
        ...
        add the result of __len__helper on the left child;
        if a right child exists,
        add the result of __len__helper on the right child;
